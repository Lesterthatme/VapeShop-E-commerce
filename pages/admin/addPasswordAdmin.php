...
if(isset($_POST['update-pass'])){
    ...
    if($newpass != $conpass){
        echo "<script>
                ...
                setTimeout(function() {
                    window.location = 'addPasswordAdmin.php?id=".$id."';
                }, 1500);
            </script>";
    }else{
        $numcha = false;
        ...
        if ($specialCha == true && $numcha == true && $upperCha == true) { // 
            // Hash the password
            $result01 = mysqli_query($conn, "SELECT * FROM users WHERE id = '$id_pass' AND ulvl = 1");
        ...
        <div class="sec2">
            <form method="POST">
                ...
                <div class="sec2sec1">
                    ...
                    <button type="submit" formaction="adminpage.php">Cancel</button>
                </div>
